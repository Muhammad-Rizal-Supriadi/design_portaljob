...
export const Header = () => {
    return (
        <>
            <header className="sticky inset-x-0 top-0 z-20 flex items-center justify-between 
            bg-white py-2 px-2 shadow-lg dark:bg-slate-900 sm:py-3 sm:px-8">
                ...
                <div className="flex grow-0 basis-1/3 justify-center md:justify-start">
                    <Link href={'/#'}>
                        <a className="my-auto flex w-[220px] md:ml-0">
                            <Logo/>
                        </a>
                    </Link>
        ...
        >
          ...
          >
            ...
            <div className='fixed top-0 bottom-0 left-0 w-full max-w-xs rounded-r-xl bg-white p-6 shadow-lg dark:bg-gray-800 '>
              <a className='mx-auto mt-4 flex w-[220px]'>
                <Logo />
              </a>
