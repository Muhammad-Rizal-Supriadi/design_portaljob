            ...
            <div className="relative h-[640px] w-full bg-red-500/20 sm:h-[55vh] md:h-[440px]">
                ...
                <div className="absolute inset-0 bg-neutral-900/70">
                    <div className="mx-auto max-w-screen-lg">
                        <div className="m-6 main-h-[60px]">{
                            <HeroInnerBanner show={showBanner} onClose={() => setShowBanner(false)}
                          />
                        }</div>
                    </div>
...
const HeroInnerBanner: React.FC<{show: boolean; onClose: () => void;
    ...
    return(
        <Transition
            ...
            leaveTo="opacity-0"
        >
        <div className="relative rounded bg-gradient-to-r from-purple-500 to-indigo-800 text-white 
        shadow-lg md:rounded-full p-3 pl-5">
            <p>
                Welcome to <span className="font-bold">Job Portal</span>. An easier and faster job discovery platform.
            </p>
